...
export default async function InvitePage({ params, searchParams }: { params: Promise<{ code: string }>; searchParams: Promise<{ preview?: string }> }) {
  ...
  return <DateInvitation invitationCode={data.public_code} creatorName={data.creator_name} crushName={data.crush_name} personalNote={data.personal_note} initialLanguage={data.language === "en" ? "en" : "zh"} initialPreview={preview === "1"} />;
}
